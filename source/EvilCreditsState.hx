...
class EvilCreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		for (i in 0...creditsStuff.length)
		{
			...
			optionText.setFormat(LangUtil.getFont('chicken'), 84, FlxColor.BLACK, CENTER);
			...
			{
				optionText.setFormat(LangUtil.getFont('animal'), 72, FlxColor.BLACK, CENTER);
				optionText.screenCenter(X);
			}
